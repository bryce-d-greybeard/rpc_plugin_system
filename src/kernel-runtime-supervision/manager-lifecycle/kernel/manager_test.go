...
import (
	...
	"rpc_plugin_system/kernel-runtime-supervision/peercred-runtime/runtime"
...
func buildPlugin(t *testing.T) string {
	...
	pluginBuildOnce.Do(func() {
		...
		cmd := exec.Command("go", "build", "-buildvcs=false", "-o", pluginBuildPath, "./plugin-authoring-sdk/echo-example/rpcplugin-echo")
