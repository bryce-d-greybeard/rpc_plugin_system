...
| `provider-observability` | event schema unit tests, SDK emission tests, admin/CLI log-read tests, redaction negative tests, downstream provider logging docs | `provider-observability.event-schema` implemented with `src/internal/eventlog` tests and evidence at `workflow/features/provider-observability.event-schema/evidence/implementation-2026-05-23.md`; `provider-observability.sdk-emission` implemented with `src/pkg/plugin` tests and evidence at `workflow/features/provider-observability.sdk-emission/evidence/implementation-2026-05-23.md`; `provider-observability.admin-read` implemented with eventlog/CLI/rpcpluginctl tests and evidence at `workflow/features/provider-observability.admin-read/evidence/implementation-2026-05-23.md`; next active slice is `provider-observability.redaction-contracts` | no accepted gaps for event-schema, sdk-emission, or admin-read; payload/secret/authority-handle/socket/private-path display is rejected or redacted by tests |
